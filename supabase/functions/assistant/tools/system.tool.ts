...
async function handleGeneralQuestion(
    ...
    if (!context.aiConfig?.key) {
        return {
            success: true,
            action_taken:
                "I'd love to help, but I need an AI provider to answer questions. Go to Account settings and add your API key (Anthropic, OpenAI, or Google Gemini) to enable AI responses.",
            data: {
    ...
    try {
        ...
        return {
            success: false,
            action_taken:
                'Failed to generate a response. Please check your AI API key in Account settings.',
            data: {
                error: message,
                isConversational: true,
            },
...
export const systemTool: ToolDefinition = {
    ...
    actions: [
        {
            action: 'system.help',
            description:
                'List all of the slash commands the user has available. Call this when the user asks "what can you do", "what commands are there", or similar.',
        ...
        // direct-invoke path uses it.
        {
            ...
            description: 'Return slash command metadata for UI hint dropdowns',
        ...
        {
            action: 'system.route_preview',
            description: 'Preview which deterministic action would handle the input',
            handler: handleRoutePreview,
        },
        ...
        // agent loop recurse into itself.
        {
            ...
            description: 'Answer general questions using AI',
    ...
    commands: [
        { command: '/help', action: 'system.help', description: 'Show all available commands' },
        {
            ...
            description: 'Send feedback: /feedback Great feature!',
        },
    ],
