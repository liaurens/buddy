...
export interface DomainManager {
  ...
  execute: (action: Intent, params: Record<string, unknown>, context: AgentContext) => Promise<ToolResult>
}
...
export function createDomainManager(domain: Domain): DomainManager {
  ...
  const actionMap = new Map<string, (params: Record<string, unknown>, context: AgentContext) => Promise<ToolResult>>()
  ...
  return {
    ...
    async execute(action: Intent, params: Record<string, unknown>, context: AgentContext): Promise<ToolResult> {
