...
export type ErrorType = 'routing_error' | 'execution_error' | 'ai_error' | 'validation_error' | 'auth_error'
export type ErrorStep = 'routing' | 'execution' | 'ai_classification' | 'ai_conversation' | 'parsing' | 'auth' | 'validation'
