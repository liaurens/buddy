...
export async function getFreshAccessToken(
  ...
  const expiresAt = creds.access_token_expires_at ? new Date(creds.access_token_expires_at).getTime() : 0
...
interface RefreshResult { access_token: string; expires_in: number }
