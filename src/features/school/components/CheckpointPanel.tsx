...
export const CheckpointPanel: React.FC<CheckpointPanelProps> = ({ assignment, onClose, onSave }) => {
                                ...
                                <div className="flex items-center gap-3 px-4 py-3">
                                    ...
                                    >
                                        <div className="flex-1">
                                            ...
                                            {!expanded && item.notes && (
                                                <p className="text-xs text-slate-500 mt-1 italic truncate">{item.notes}</p>
                                            )}
                                        </div>
                                        {expanded
