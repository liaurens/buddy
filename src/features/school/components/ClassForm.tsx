...
interface ClassFormProps {
    ...
    onClose: () => void;
    onSubmit: (params: { name: string; instructor?: string; term?: string; color?: string }) => Promise<void>;
}
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center justify-center p-4">
            <form onSubmit={submit} className="w-full max-w-md bg-white rounded-2xl p-5 space-y-4 shadow-xl">
                <div className="flex items-center justify-between">
                    <h2 className="text-lg font-semibold text-slate-900">{initial ? 'Edit class' : 'New class'}</h2>
