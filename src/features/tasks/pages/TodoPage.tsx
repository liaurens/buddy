            ...
            <form onSubmit={handleAdd} className="bg-white p-2 rounded-2xl shadow-sm border border-slate-200 flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex gap-2 p-1">
                    ...
                    <input
                        ...
                        className="bg-slate-50 border-none text-sm font-medium text-slate-600 rounded-lg px-3 py-2 cursor-pointer outline-none focus:ring-2 focus:ring-indigo-500 hover:bg-slate-100 transition-colors"
                    />
