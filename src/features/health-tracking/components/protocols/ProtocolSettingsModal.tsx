...
const ProtocolSettingsModal: React.FC<ProtocolSettingsModalProps> = ({
  isOpen,
  onClose,
}) => {
  const { user } = useAuth();
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('defaultDoseTime', e.target.value)
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('reminderAdvanceMinutes', parseInt(e.target.value) || 0)
                }
                min="0"
                max="180"
                className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('reminderSound', e.target.checked)
                }
                className="h-4 w-4 text-blue-600 rounded border-slate-300 focus:ring-blue-500"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('showUpcomingCount', parseInt(e.target.value) || 0)
                }
                min="1"
                max="30"
                className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('skipWeekends', e.target.checked)
                }
                className="h-4 w-4 text-blue-600 rounded border-slate-300 focus:ring-blue-500"
              />
            </div>
