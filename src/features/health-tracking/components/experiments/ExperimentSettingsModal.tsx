...
const ExperimentSettingsModal: React.FC<ExperimentSettingsModalProps> = ({
  isOpen,
  onClose,
}) => {
  const { user } = useAuth();
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('defaultDurationDays', parseInt(e.target.value) || 0)
                }
                min="1"
                max="365"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting('showCorrelationThreshold', parseFloat(e.target.value) || 0)
                }
                min="0"
                max="1"
                step="0.01"
