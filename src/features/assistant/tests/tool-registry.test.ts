...
type Domain = 'planning' | 'health' | 'mental' | 'content' | 'improvement' | 'studying' | 'projects' | 'extra'
...
const mockTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    commands: [
      { command: '/checkin', action: 'tracker.checkin', description: 'Check in' },
    ],
    rules: [],
  },
]
...
describe('Tool Registry', () => {
  ...
  it('all tools have a valid domain', () => {
    const validDomains: Domain[] = ['planning', 'health', 'mental', 'content', 'improvement', 'studying', 'projects', 'extra']
    for (const tool of mockTools) {
