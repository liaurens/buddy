...
export const calendarConfigSchema = z.object({
    calendarUrl: z
        ...
        .refine(
            ...
            {
                message: 'URL must be from a supported calendar provider (Google Calendar, Outlook, or iCloud)',
            }
        ),
    calendarName: z
        .string()
...
export const dataImportSchema = z.object({
    ...
    message: 'Import data must contain at least one of: trackers, entries, protocols, strategies, todos, or settings',
});
