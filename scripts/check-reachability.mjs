...
const ALLOWED = [
    ...
    /^src\/vite-env\.d\.ts$/,
    // Preserved deliberately — the only implementation of the urgent scheduling
    // flow (parent_todo_id / notes / Google Calendar columns). Pending redesign;
    // see src/features/tasks/README.md.
